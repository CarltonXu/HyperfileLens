...
<template>
 ...
 <div>
 <h1 class="text-2xl font-bold text-foreground">{{ t('insightOverview.title') }}</h1>
 <p class="text-foreground-secondary mt-1">{{ t('insightOverview.subtitle') }}</p>
 </div>
 ...
 <span class="text-sm text-foreground-secondary">{{ stat.label }}</span>
 </div>
 ...
 <h2 class="text-lg font-semibold text-foreground mb-4">{{ t('insightOverview.fileCategories') }}</h2>
 ...
 >
 <p class="text-2xl font-bold text-foreground">{{ cat.percentage }}%</p>
 <p class="text-sm text-foreground-secondary mt-1">{{ locale === 'zh-CN' ? cat.name_zh : cat.name }}</p>
 ...
 <h3 class="text-base font-semibold text-foreground mt-4">{{ card.title }}</h3>
 <p class="text-sm text-foreground-secondary mt-1">{{ card.description }}</p>
 <div v-if="card.stats" class="mt-3 px-2 py-1 rounded bg-background-tertiary inline-block">
 <span class="text-xs font-medium text-foreground-secondary">{{ card.stats }}</span>
 </div>
 </div>
 </div>
 </div>
 ...
 <!-- Risk Summary -->
 <div class="bg-card rounded-xl border border-border p-6">
 <h2 class="text-lg font-semibold text-foreground mb-4">{{ t('insightOverview.riskSummary') }}</h2>
 <div class="space-y-3">
 ...
 <div class="bg-card rounded-xl border border-border p-6">
 <h2 class="text-lg font-semibold text-foreground mb-4">{{ t('insightOverview.optimizationSuggestions') }}</h2>
 <div class="space-y-3">

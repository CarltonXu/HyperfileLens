...
<template>
 ...
 <h1 class="text-xl font-bold text-foreground tracking-tight">{{ t('auth.createAccount') }}</h1>
 <p class="text-sm text-foreground-secondary mt-1">{{ t('auth.registerSubtitle') }}</p>
 </div>
 ...
 <div>
 <label class="block text-sm text-foreground-secondary mb-1">{{ t('auth.firstName') }}</label>
 <input
 v-model="firstName"
 type="text"
 class="w-full px-3 py-2 text-sm bg-background-secondary border border-border rounded-lg text-foreground placeholder:text-foreground-muted focus:outline-none focus:ring-2 focus:ring-emerald-500/50 focus:border-emerald-500/50"
 :placeholder="t('auth.firstNamePlaceholder')"
 required
 />
 </div>
 <div>
 <label class="block text-sm text-foreground-secondary mb-1">{{ t('auth.lastName') }}</label>
 <input
 v-model="lastName"
 type="text"
 class="w-full px-3 py-2 text-sm bg-background-secondary border border-border rounded-lg text-foreground placeholder:text-foreground-muted focus:outline-none focus:ring-2 focus:ring-emerald-500/50 focus:border-emerald-500/50"
 ...
 v-model="email"
 type="email"
 class="w-full pl-9 pr-3 py-2 text-sm bg-background-secondary border border-border rounded-lg text-foreground placeholder:text-foreground-muted focus:outline-none focus:ring-2 focus:ring-emerald-500/50 focus:border-emerald-500/50"
 ...
 class="w-full pl-9 pr-9 py-2 text-sm bg-background-secondary border border-border rounded-lg text-foreground placeholder:text-foreground-muted focus:outline-none focus:ring-2 focus:ring-emerald-500/50 focus:border-emerald-500/50"
 ...
 <span class="text-xs text-foreground-muted w-12">{{ passwordStrength.text }}</span>
 </div>
 </div>
 ...
 type="text"
 maxlength="6"
 class="w-full pl-9 pr-3 py-2 text-sm bg-background-secondary border border-border rounded-lg text-foreground placeholder:text-foreground-muted focus:outline-none focus:ring-2 focus:ring-emerald-500/50 focus:border-emerald-500/50 uppercase tracking-wider text-center"
 :placeholder="t('auth.captchaPlaceholder')"
 required
 />
 </div>
 <div class="relative h-9 w-24 rounded-lg border border-border bg-background-secondary cursor-pointer overflow-hidden hover:border-emerald-500/50 transition-colors" @click="refreshCaptcha" :title="t('auth.refreshCaptcha')">
 <img
 v-if="captchaUrl"
 :src="captchaUrl"
 alt="Captcha"
 ...
 type="checkbox"
 class="mt-0.5 w-3.5 h-3.5 rounded border-border-secondary bg-background text-emerald-500 focus:ring-emerald-500/50"
 />

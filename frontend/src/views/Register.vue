...
<template>
  <div
    ...
    <div class="absolute inset-0 overflow-hidden">
      ...
      <!-- Floating Particles -->
      <div
        class="absolute top-1/4 left-1/4 w-64 h-64 bg-emerald-500/10 rounded-full blur-3xl animate-pulse"></div>
      <div
        class="absolute bottom-1/4 right-1/4 w-96 h-96 bg-cyan-500/10 rounded-full blur-3xl animate-pulse"
        style="animation-delay: 1s"></div>
      <div
        class="absolute top-1/2 right-1/3 w-48 h-48 bg-teal-500/10 rounded-full blur-3xl animate-pulse"
    ...
    <div class="w-full max-w-sm relative z-10">
      ...
      <div class="text-center mb-6">
        <div
          class="inline-flex items-center justify-center w-12 h-12 bg-gradient-to-br from-emerald-500 to-cyan-600 rounded-xl mb-3 shadow-lg shadow-emerald-500/25">
          <svg
      ...
      <div
        ...
        <form @submit.prevent="handleRegister" class="space-y-3.5">
          ...
          <div>
            ...
            <div v-if="password" class="flex items-center gap-2 mt-1.5">
              ...
              <span class="text-xs text-foreground-muted w-12">{{
          ...
          <div>
            ...
            <div class="flex gap-2">
              ...
              <div
                class="relative h-9 w-24 rounded-lg border border-border bg-background-secondary cursor-pointer overflow-hidden hover:border-emerald-500/50 transition-colors"
        ...
        <p class="text-center text-sm text-foreground-secondary">
          ...
          <router-link
            to="/login"
            class="text-emerald-500 hover:text-emerald-600 dark:text-emerald-400 dark:hover:text-emerald-300 font-medium transition-colors">
            {{ t("auth.loginNow") }}
          </router-link>
        </p>
      </div>

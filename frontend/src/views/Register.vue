...
<template>
  ...
  >
    ...
    <div class="absolute inset-0 overflow-hidden">
      ...
      <!-- Floating Particles -->
      <div
        class="absolute top-1/4 left-1/4 w-64 h-64 bg-emerald-500/10 rounded-full blur-3xl animate-pulse"
      ></div>
      <div
    ...
    <div class="w-full max-w-sm relative z-10">
      ...
      <div class="text-center mb-6">
        <BrandLogo variant="full" size="lg" class="mb-3" />
            ...
            <div class="flex gap-2">
              <div class="relative flex-1">
                ...
                <input
                  ...
                  type="text"
                  maxlength="6"
                  class="h-12 w-full pl-9 pr-3 text-base bg-background-secondary border border-border rounded-lg text-foreground placeholder:text-foreground-muted focus:outline-none focus:ring-2 focus:ring-emerald-500/50 focus:border-emerald-500/50 uppercase tracking-wider text-center"
                  :placeholder="t('auth.captchaPlaceholder')"
                  required
                />
              </div>
              <div
                class="relative h-12 w-36 rounded-lg border border-border bg-white cursor-pointer overflow-hidden hover:border-emerald-500/50 transition-colors dark:bg-slate-100"

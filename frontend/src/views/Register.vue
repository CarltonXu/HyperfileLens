            ...
            <div class="flex gap-2">
              <div class="relative flex-1">
                ...
                <input
                  ...
                  type="text"
                  maxlength="6"
                  class="h-10 w-full pl-9 pr-3 text-sm bg-background-secondary border border-border rounded-lg text-foreground placeholder:text-foreground-muted focus:outline-none focus:ring-2 focus:ring-emerald-500/50 focus:border-emerald-500/50 uppercase tracking-wider text-center"
                  :placeholder="t('auth.captchaPlaceholder')"
                  required
                />
              </div>
              <div
                class="relative h-10 w-28 rounded-lg border border-border bg-white cursor-pointer overflow-hidden hover:border-emerald-500/50 transition-colors dark:bg-slate-100"

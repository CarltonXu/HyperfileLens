...
function dropFavoriteGroup(targetGroupId: string) {
  ...
  const order = moveFavoriteGroup(sourceGroupId, targetGroupId) || orderedFavoriteGroupIds();
  ...
  <div class="min-h-screen app-background">
    ...
    >
      ...
      <header class="sticky top-0 z-30 surface-card border-b border-border">
        <div class="relative flex min-w-0 items-center justify-between h-16 px-6">
              ...
              >
                ...
                >
                  ...
                  <section
                    ...
                    @dragover.prevent="previewFavoriteGroupDrop(group.id, $event)"
                  ...
                  >
                    <div class="flex items-center gap-2 px-1">
                      ...
                      <p class="text-[11px] font-semibold uppercase tracking-wider text-foreground-muted">
                        {{ group.title }}
                      </p>
                      <span
                    ...
                    <div class="grid grid-cols-2 gap-1">
                      ...
                      >
                        ...
                        <div class="min-w-0 flex-1 py-0.5">
                          <p class="whitespace-normal text-sm font-medium leading-5">
                            {{ fav.name }}
                          </p>
                        </div>
                        <button
          ...
          <div class="relative z-20 flex min-w-0 shrink-0 items-center gap-4 justify-end">
            <!-- Theme Switcher -->
            <ThemeSwitcher />

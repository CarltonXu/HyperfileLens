            ...
            <template v-else-if="repo.repo_type === 'nas'">
              ...
              <div class="flex items-center gap-2 text-sm">
                <span
                  ...
                  >{{ repo.config?.nas_type?.toUpperCase() || "NFS" }}</span
                >
              </div>
            </template>
          ...
          <div class="mb-4">
            ...
            >
              ...
              <span
                ...
                {{ formatBytes(repo.capacity || 0) }}</span
              >
            </div>
            <div
                  ...
                  <div v-if="repo.capacity">
                    ...
                    <div class="flex items-center gap-2 mb-1">
                      ...
                      >
                        ...
                        <div
                          v-if="
                            repo.quota_enabled && (repo.quota_bytes || 0) > 0
                          "
                          class="h-full absolute left-0 bg-slate-300 dark:bg-slate-600/50 dark:bg-slate-600/50 opacity-50 rounded-full transition-all"
                          :style="{
        ...
        >
          ...
          <div class="flex-1 overflow-y-auto p-6 space-y-4">
            ...
            >
              ...
              <!-- Bound Sync Proxy for S3 initialization -->
              <div>
                <label class="block text-sm font-medium text-foreground mb-1"
                ...
                <div class="grid grid-cols-2 gap-4">
                  ...
                  <div class="flex items-center justify-between py-2">
                    ...
                    <button
                      type="button"
                      @click="
                        newRepo.s3_config.use_tls = !newRepo.s3_config.use_tls
                      "
                      :class="[
            ...
            >
              ...
              >
                ...
                <span class="text-sm text-green-700 dark:text-green-400"
                  ...
                  <code
                    class="bg-green-100 dark:bg-green-800/50 px-1 rounded"
                    >{{ newRepo.local_config.path }}</code
                  ></span
                >
              </div>
          ...
          <div class="p-6 space-y-4">
            ...
            <div class="flex items-center gap-3">
              ...
              <div class="flex-1">
                <p class="font-medium text-foreground dark:text-slate-200">
                  {{ getRepoTypeLabel(selectedRepo.repo_type) }}
                </p>
            ...
            <div class="grid grid-cols-2 gap-4">
              <div class="bg-background-secondary rounded-lg p-4">
                ...
                <p class="font-semibold text-slate-800 text-lg">
                  {{ formatBytes(selectedRepo.capacity || 0) }}
                </p>
              </div>
              <div class="bg-background-secondary rounded-lg p-4">
                <p class="text-xs text-foreground-secondary">
                ...
                <p class="font-semibold text-slate-800 text-lg">
                  {{ formatBytes(selectedRepo.used_space || 0) }}
                </p>
              </div>
            </div>
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <div
                    ...
                    :class="
                      getProgressColor(selectedRepo.quota_status || 'unlimited')
                    "
                    :style="{
              ...
              <div class="grid grid-cols-2 gap-3 text-sm">
                <div>
                  ...
                  <p class="font-medium text-foreground dark:text-slate-200">
                    {{
                      selectedRepo.quota_bytes_formatted ||
                ...
                <div>
                  ...
                  <p class="font-medium text-foreground dark:text-slate-200">
                    {{ selectedRepo.quota_warning_threshold || 80 }}%
                  </p>
                </div>
              </div>
            </div>
            ...
            >
              ...
              <div class="grid grid-cols-2 gap-3 text-sm">
                ...
                <div>
                  ...
                  <p class="text-foreground dark:text-slate-200 font-mono">
                    {{ selectedRepo.credentials_masked?.access_key || "-" }}
                  </p>
                </div>
                <div>
                  <p class="text-xs text-foreground-secondary">
                  ...
                  <p class="text-foreground dark:text-slate-200">
                    {{
                      selectedRepo.config?.use_tls !== false
                        ? t("common.yes")
                        : t("common.no")
                    }}
                  </p>
            ...
            >
              ...
              <div class="grid grid-cols-2 gap-3 text-sm">
                ...
                <div>
                  ...
                  <p class="text-foreground dark:text-slate-200">
                    {{ selectedRepo.config?.export_path || "-" }}
                  </p>
                </div>
                <div>
                  <p class="text-xs text-foreground-secondary">
                  ...
                  <p class="text-foreground dark:text-slate-200">
                    {{ selectedRepo.config?.nas_type?.toUpperCase() || "NFS" }}
                  </p>
                </div>
                <div>
                  <p class="text-xs text-foreground-secondary">
            ...
            <div class="bg-background-secondary rounded-lg p-4">
              ...
              <div class="flex items-center gap-2">
                ...
                <span
                  v-if="getNode(selectedRepo.bound_node)?.role"
                  class="text-xs text-foreground-muted"
                  >({{ getNode(selectedRepo.bound_node)?.role }})</span
                >
              </div>
            </div>
                ...
                <div class="grid grid-cols-2 gap-3 text-sm">
                  ...
                  <div>
                    ...
                    <p class="font-medium text-foreground">
                      {{
                        selectedTestResult.details.connectivity.response_time ||
                        0
                      }}ms
                    </p>
                  </div>
                  ...
                  >
                    ...
                    <p class="font-medium text-red-600">
                      {{ selectedTestResult.details.connectivity.error }}
                    </p>
                  </div>
                </div>
              </div>
              ...
              >
                ...
                <div class="grid grid-cols-3 gap-3 text-sm">
                  ...
                  <div>
                    ...
                    <p class="font-medium text-foreground">
                      {{
                        selectedTestResult.details.write_test.write_speed || 0
                      }}
                      MB/s
                    </p>
                  </div>
                  <div>
                    ...
                    <p class="font-medium text-foreground">
                      {{
                        selectedTestResult.details.write_test.read_speed || 0
                      }}
                      MB/s
                    </p>
                  </div>
                  ...
                  >
                    ...
                    <p class="font-medium text-red-600">
                      {{ selectedTestResult.details.write_test.error }}
                    </p>
                  </div>
                </div>
              </div>
              ...
              >
                ...
                <div class="grid grid-cols-3 gap-3 text-sm mb-3">
                  <div>
                    ...
                    <p class="font-medium text-foreground">
                      {{
                        formatBytes(
                          selectedTestResult.details.space_info.total_bytes ||
                            0,
                        )
                      }}
                    </p>
                  ...
                  <div>
                    ...
                    <p class="font-medium text-foreground">
                      {{
                        formatBytes(
                          selectedTestResult.details.space_info.used_bytes || 0,
                        )
                      }}
                    </p>
                  </div>
                  <div>
                    ...
                    <p class="font-medium text-foreground">
                      {{
                        formatBytes(
                          selectedTestResult.details.space_info.free_bytes || 0,
                        )
                      }}
                    </p>
                  </div>
                ...
                <p class="text-xs text-foreground-secondary text-center mt-1">
                  {{
                    selectedTestResult.details.space_info.total_bytes
                      ? (
                          (selectedTestResult.details.space_info.used_bytes /
                            selectedTestResult.details.space_info.total_bytes) *
                          100
                        ).toFixed(1)
                      : 0

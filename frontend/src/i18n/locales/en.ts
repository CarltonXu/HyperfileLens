export default {
  ...
  repository: {
    ...
    confirmInitKopia: 'Are you sure you want to initialize this Kopia repository? This will create repository metadata on the bound Sync Proxy.',
    encryptionPasswordPrompt: 'Enter the Kopia repository encryption password (at least 8 characters)',
    confirmPasswordPrompt: 'Enter the Kopia repository encryption password again',
    passwordMismatch: 'Passwords do not match',
  ...
  settings: {
    ...
    preferences: {
      ...
      resetConfirm: 'Are you sure you want to reset all pagination settings to default values?'
    },
  ...
  alertsCenter: {
    ...
    policies: {
      ...
      subtitle: 'Create, edit, duplicate, enable and disable global alert policies.',
      ...
      monitorTargetDesc: 'Select the resource scope to monitor. Selected scope loads resources from the platform automatically.',
      monitorTargetEventDesc: 'Job and Event alerts are triggered by platform event streams, so a concrete monitored resource is not required in phase one.',
      jobTargetHint: 'Job alerts listen to job result events such as job_failed, job_timeout and partial_success.',
      eventTargetHint: 'Event alerts listen to platform events such as user, license, repository, configuration and security events.',
      triggerRule: 'Trigger Rule',
      triggerRuleDesc: 'The form changes dynamically according to alert type.',
      recoveryRule: 'Recovery Rule',
      recoveryRuleDesc: 'Configure when the alert should be automatically resolved.',
      notification: 'Notification',
      notificationDesc: 'Select channels and notification timing for firing and recovery events.',
      ...
      description: 'Description',
      descriptionPlaceholder: 'Describe when and why this alert should be triggered.',
      ...
      createDesc: 'Configure trigger rules, recovery rules and notification channels.',
      editTitle: 'Edit Alert Policy',
      editDesc: 'Update the policy using the same fields defined by the alert center design.',
      rulesAndBindingsJson: 'Rules And Bindings JSON'
    },
    active: {
      title: 'Active Alerts',
      subtitle: 'Current firing alerts that need acknowledgement or resolution.',
    ...
    history: {
      title: 'Alert History',
      subtitle: 'Resolved and historical alert records with filtering and pagination.',
      searchPlaceholder: 'Search alert or resource',
      firstTriggered: 'First Triggered',
    ...
    channels: {
      ...
      subtitle: 'Configure email, webhook, DingTalk and WeCom notification channels.',
      ...
      noChannelsDesc: 'Create your first notification channel to receive alerts.',
      email: {
        smtpHost: 'SMTP Host',
        smtpPort: 'SMTP Port',
    ...
    form: {
      ...
      enableAutoRecoveryDesc: 'Automatically resolve the alert when the recovery condition is met.',
  ...
  alertsPage: {
    ...
    subtitle: 'Configure system monitoring, alert rules, notification channels, and alert history.',
    tabs: {
    ...
    monitor: {
      subtitle: 'Global server monitoring across CPU, memory, disk, network traffic, disk IO, and IOPS.',
    ...
    rulesHint: 'Define thresholds, severity, cooldown, and notification behavior for global alerts.',
    channelsHint: 'Configure email and webhook delivery channels for alert notifications.',

export default {
  ...
  licenses: {
    ...
    validateAllLicenses: 'Validate All Licenses',
    validationResult: 'Validation Result',
    activate: 'Activate',
    activateSuccess: 'License activated successfully',
    activateFailed: 'License activation failed',
    alreadyActivated: 'License already activated',
    confirmDelete: 'Are you sure you want to delete license "{name}"?',
    stats: 'Statistics',

export default {
  ...
  repository: {
    ...
    s3: {
      ...
      existingBucketWarningDetail: '选择已有的 Bucket 将会进行 Kopia 初始化操作，如果 Bucket 中已有重要数据，可能会被覆盖或丢失。请确保 Bucket 为空或数据可以安全清理。',
    ...
    initKopia: '初始化 Kopia',
    confirmInitKopia: '确定要初始化此 Kopia 仓库吗？初始化会在绑定的 Sync Proxy 上创建仓库元数据。',
  ...
  alertsCenter: {
    ...
    policies: {
      ...
      monitorTarget: '监控目标',
      monitorTargetDesc: '选择要监控的资源范围。Selected 会自动从平台加载资源列表。',
      monitorTargetEventDesc: '任务告警和事件告警由平台事件流触发，一期不需要选择具体监控资源。',
      jobTargetHint: '任务告警监听 job_failed、job_timeout、partial_success 等任务结果事件。',
      eventTargetHint: '事件告警监听用户、License、仓库、配置和安全等平台事件。',
      triggerRule: '触发规则',

export default {
  ...
  resourceTopology: {
    ...
    modal: {
      title: "源端链路拓扑",
      resolving: "正在从后端解析拓扑...",
      executorSelection: "执行节点选择",
      fallback: "后端拓扑解析不可用，当前展示基于本地数据推断的拓扑。",
    },
    scenarios: {
      networkToObject: "网络源由 Sync Proxy 读取，并写入对象存储。",
      agentLocal: "Agent Proxy 读取本地源端，并直接写入目标仓库。",
      default: "执行 Proxy 读取源端数据，并将备份快照写入目标仓库。",
    },
    nodes: {
      source: "源端",
      target: "目标",
      ...
      gatewaySubtitle: "AI Insights 读取仓库快照",
      backupService: "备份服务",
    },
    roles: {
    ...
    empty: {
      noProxySelected: "未选择 Proxy",
      noRepositorySelected: "未选择仓库",
      noSourceSelected: "未选择源端",
      noGatewayConnected: "未连接 Gateway",
      autoPlacement: "自动调度",
    },
    edges: {
      readSource: "读取源端",
  ...
  recoveryTasks: {
    ...
    form: {
      targetNode: "目标节点",
      repository: "存储仓库",
      sourceResource: "备份源资源",
      allSourceResources: "全部备份源资源",
      backupTask: "备份任务",
      snapshot: "快照",
    ...
    sections: {
      source: "恢复点",
      sourceHelp: "选择作为恢复来源的备份任务和指定时间点快照。",
      target: "恢复目标",
    ...
    wizard: {
      ...
      recoveryPoint: "恢复点",
      recoveryPointHelp: "选择恢复来源备份任务和指定时间点的快照。",
      scope: "恢复范围",
    ...
    empty: {
      ...
      selectBackupTaskTitle: "请先选择备份任务",
      selectBackupTaskDescription: "选择备份任务后，这里会展示该任务的可用快照。",
      noSnapshotsTitle: "未找到快照",
      noSnapshotsDescription: "请尝试选择其他备份任务，或调整快照搜索条件。",
    },
  },
  ...
  settings: {
    ...
    aiInsights: {
      ...
      testEmptyState: "发送一条消息来验证 Provider 回复。这里的对话只用于本次快速测试。",
  ...
  recoveryExports: {
    ...
    newExport: "新建导出",
    newExportDesc: "选择一个可用快照，勾选文件或目录，然后创建下载压缩包。",
    chooseSnapshot: "选择快照",
    chooseBackupTask: "选择备份任务",
    filterBySourceResource: "备份源资源",
    allSourceResources: "全部备份源资源",
    allBackupTasks: "全部备份任务",
    allRepositories: "全部备份仓库",
    noBackupTasks: "未找到备份任务。",
    noBackupTasksForSource: "此备份源资源下未找到备份任务。",
    backupTasksLoadFailed: "加载备份任务失败",
    sourceResourcesLoadFailed: "加载备份源资源失败",
    repositoriesLoadFailed: "加载备份仓库失败",
    selectBackupTaskFirst: "请先选择备份任务，再加载该任务的快照。",
    resetFilters: "重置",
    snapshotSearchPlaceholder: "搜索快照或备份任务",
    snapshotResultCount: "显示 {shown} / {total} 个快照",
    noAvailableSnapshots: "未找到可用快照。",
    snapshotsLoadFailed: "加载快照失败",
    exportNamePlaceholder: "导出任务名称",
    exportDescriptionPlaceholder: "此导出任务的可选说明",

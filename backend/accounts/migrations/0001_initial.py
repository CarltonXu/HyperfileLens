        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "description",
                    models.TextField(
                        blank=True, help_text="Human-readable description of the role"
                    ),
                ),
                (
                    "permissions",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "first_name",
                    models.CharField(
                        blank=True, help_text="User first name", max_length=150
                    ),
                ),
                (
                    "last_name",
                    models.CharField(
                        blank=True, help_text="User last name", max_length=150
                    ),
                ),
                (
                    "is_active",
                ...
                (
                    "last_login_at",
                    models.DateTimeField(
                        blank=True, help_text="Last time user logged in", null=True
                    ),
                ),
                (
                    "phone",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "prefix",
                    models.CharField(
                        help_text="Prefix of the key for display purposes", max_length=8
                    ),
                ),
                (
                    "is_active",
            ...
            options={
                ...
                "ordering": ["-created_at"],
                "indexes": [
                    models.Index(fields=["key"], name="accounts_ap_key_07b1dd_idx"),
                    models.Index(
                        fields=["user", "is_active"],
                        name="accounts_ap_user_id_8e268c_idx",
                    ),
                ],
            },
        ),

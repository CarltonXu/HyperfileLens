    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(help_text="Recovery task name", max_length=255),
                ),
                (
                    "description",
                ...
                (
                    "exclude_patterns",
                    models.JSONField(
                        blank=True, default=list, help_text="File patterns to exclude"
                    ),
                ),
                (
                    "status",
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["status"], name="recovery_ta_status_7d3e1e_idx"
                    ),
                    models.Index(
                        fields=["target_node", "status"],
                        name="recovery_ta_target__8d16ac_idx",
                    ),
                    models.Index(
                        fields=["snapshot", "status"],
                        name="recovery_ta_snapsho_e31f35_idx",
                    ),
                ],
            },
        ),

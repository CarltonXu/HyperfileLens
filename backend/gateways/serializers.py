...
class GatewayHeartbeatSerializer(serializers.Serializer):
    ...
    network_interfaces = serializers.JSONField(required=False)
    network_bytes_sent = serializers.IntegerField(required=False)
    network_bytes_recv = serializers.IntegerField(required=False)
    network_packets_sent = serializers.IntegerField(required=False)
    network_packets_recv = serializers.IntegerField(required=False)
    ...
    cpu_physical = serializers.IntegerField(required=False)
    uptime = serializers.IntegerField(required=False)
    load_average = serializers.ListField(required=False)
    process_count = serializers.IntegerField(required=False)
    disk_io = serializers.JSONField(required=False)

...
# Optional SMTP defaults. Runtime SMTP profiles can still be managed in System Settings.
...
DEFAULT_FROM_EMAIL = os.environ.get('DEFAULT_FROM_EMAIL', 'HyperFileLens <noreply@localhost>')

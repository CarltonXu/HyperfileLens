...
urlpatterns = [
    ...
    path('<uuid:pk>/user-candidates/', TenantViewSet.as_view({'get': 'user_candidates'}), name='tenant-user-candidates'),
    ...
    path('invitations/validate/', TenantInvitationViewSet.as_view({'get': 'validate'}), name='tenant-invitation-validate'),
    path('invitations/accept/', TenantInvitationViewSet.as_view({'post': 'accept'}), name='tenant-invitation-accept'),
